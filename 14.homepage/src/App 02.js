...
{/* 
      ...
      <Link to="/detail">상세 페이지</Link>&emsp;
...
*/}
      ...
      <Routes>
        ...
        {/* path='/*' : 위에서 정의한 path 외의 모든 path를 말한다 */}
        <Route path="*" element={
          <div>없는 페이지니 돌아가기 바람</div>
        }/>
      </Routes>
    </div>
  );
...
function PListCol(props) {
  return (
    <>
      <Col>
        <img src={`${process.env.PUBLIC_URL}/img/clothes${props.clothes.id}.jpg`} width="80%"/>
